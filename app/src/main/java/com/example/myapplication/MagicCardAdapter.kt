...
class MagicCardAdapter(
    magicCards1: MainActivity,
    private val magicCards: List<MagicCard>,
    private val onItemClickListener: (MagicCard) -> Unit
) :
    ...
    override fun onBindViewHolder(holder: MagicCardViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            // Notify the click event to the external listener
            onItemClickListener.invoke(magicCard)
        }
    }
